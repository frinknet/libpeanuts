...
> TODO: We need to get this in all the main distros. Until then you can build easily by either using the .c and .h file in your project or building them separately.

# Building

This uses the ZeroConf metabuild sytem to do it's dirtywork but you will need docker and a bit pf space for the internal build system. We are working on shrinking Metabuild but it's not easy to put a ZeroConf build system in a singl binary.
